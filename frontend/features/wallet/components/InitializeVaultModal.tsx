      ...
      <div className="bg-surface-container max-w-md w-full rounded-xl p-5 border border-outline-variant/40 shadow-2xl flex flex-col gap-4">
        <div className="flex items-center justify-between pb-2 border-b border-outline-variant/20">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-on-surface">Create Protected Project Payment</h3>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 text-xs">
          <div className="flex flex-col gap-1">
            <label className="font-semibold text-on-surface">Project / Job Title *</label>
            <input
              type="text"
              required
              value={title}
          ...
          <div className="flex flex-col gap-1">
            <label className="font-semibold text-on-surface">Freelancer Email or Username *</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="flex flex-col gap-1">
              <label className="font-semibold text-on-surface">Deposit Amount *</label>
              <input
                type="number"
                required
                min="50"
            ...
            <div className="flex flex-col gap-1">
              <label className="font-semibold text-on-surface">Currency</label>
              <select
                value={currency}
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            >
              {isSubmitting ? 'Processing Deposit...' : 'Fund & Protect Payment'}
            </button>
          </div>
        </form>
      </div>

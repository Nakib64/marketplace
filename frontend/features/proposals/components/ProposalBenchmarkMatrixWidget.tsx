      ...
      <div className="flex flex-col gap-3  text-xs">
        ...
        <div className="flex flex-col gap-1">
          <div className="flex justify-between items-center text-on-surface font-sans text-xs">
            ...
            <span className=" text-primary font-semibold">Alex R. (96.4/100)</span>
          </div>
        ...
        <div className="flex flex-col gap-1 pt-1">
          <div className="flex justify-between items-center text-on-surface font-sans text-xs">
            ...
            <span className=" text-secondary font-semibold">Sophia (0.12ms)</span>
          </div>
          <div className="w-full bg-surface-container-low h-1.5 rounded-full overflow-hidden">
        ...
        <div className="flex flex-col gap-1 pt-1">
          <div className="flex justify-between items-center text-on-surface font-sans text-xs">
            ...
            <span className=" text-on-surface">2.5w — 4.0w</span>
          </div>
        ...
        <div className="flex flex-col gap-1 pt-1">
          <div className="flex justify-between items-center text-on-surface font-sans text-xs">
            ...
            <span className=" text-primary font-semibold">Alex (-$500)</span>
          </div>
          <div className="grid grid-cols-3 gap-1 text-center text-[11px]">

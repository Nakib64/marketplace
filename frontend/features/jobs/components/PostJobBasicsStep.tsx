  ...
  return (
    <div className="bg-surface-container rounded-2xl p-6 sm:p-8 flex flex-col gap-6 border border-outline-variant/30 shadow-sm">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          {...register('title')}
          placeholder="e.g. Senior Full-Stack Engineer for Web Platform"
          ...
          {DOMAIN_CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-3.5 py-2 rounded-full text-xs font-medium transition-all cursor-pointer ${isSelected
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          className="w-full bg-surface-container-lowest text-on-surface rounded-xl p-4 text-sm border border-outline-variant/40 focus:outline-none focus:border-primary resize-y leading-relaxed"
        />
        {errors.description && (

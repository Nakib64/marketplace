    ...
    <div className="bg-surface-container-low border border-outline-variant/30 rounded-xl p-5 shadow-sm flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-1">
        <div className="bg-surface-container p-2.5 rounded-lg border border-outline-variant/20 flex flex-col">
          <span className="text-[11px] text-on-surface-variant">Payment Mode</span>
          <span className="text-xs text-on-surface font-semibold flex items-center gap-1.5 mt-1">
        ...
        <div className="bg-surface-container p-2.5 rounded-lg border border-outline-variant/20 flex flex-col">
          ...
          <span className=" text-xs text-on-surface font-semibold mt-1">{contract.startDate}</span>
        </div>
        <div className="bg-surface-container p-2.5 rounded-lg border border-outline-variant/20 flex flex-col">
          <span className="text-[11px] text-on-surface-variant">Protection</span>
          <span className="text-xs text-on-surface font-semibold mt-1">Guaranteed</span>
        </div>
        <div className="bg-surface-container p-2.5 rounded-lg border border-outline-variant/20 flex flex-col">
          <span className="text-[11px] text-on-surface-variant">Review Window</span>
          <span className=" text-xs text-on-surface font-semibold mt-1">{contract.gracePeriodHours} Hours</span>
        </div>
      </div>

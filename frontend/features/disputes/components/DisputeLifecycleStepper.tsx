  ...
  return (
    <div className="bg-surface-container rounded-xl p-5 border border-outline-variant/30 flex flex-col gap-4 shadow-sm">
      <div className="flex items-center justify-between pb-1 border-b border-outline-variant/20">
        ...
        <span className=" text-xs text-on-surface-variant">Stage {currentStep} of 4</span>
      </div>
        ...
        {steps.map((step) => {
            ...
            return (
              <div key={step.num} className="bg-surface-container-high rounded-xl p-3.5 flex flex-col gap-2 border border-primary/40 shadow-md">
                <div className="flex items-center justify-between">
                  <span className="w-6 h-6 rounded-full bg-surface-container-lowest flex items-center justify-center text-primary font-bold text-xs ">
                    {step.num}
                  </span>
                  <span className=" text-primary font-medium text-[11px]">{step.date}</span>
                </div>
                ...
                <div className="mt-auto pt-1 flex items-center gap-1.5 text-primary text-[11px] ">
            ...
            return (
              <div key={step.num} className="bg-surface-container-low rounded-xl p-3.5 flex flex-col gap-2 border border-outline-variant/20 opacity-90">
                <div className="flex items-center justify-between">
                  ...
                  <span className=" text-on-surface-variant text-[11px]">{step.date}</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-semibold text-on-surface">{step.title}</span>
                  <span className="text-on-surface-variant text-[11px] mt-0.5 leading-tight">{step.desc}</span>
                </div>
                <div className="mt-auto pt-1 flex items-center gap-1 text-primary text-[11px] ">
          ...
          return (
            <div key={step.num} className="bg-surface-container-low/60 rounded-xl p-3.5 flex flex-col gap-2 border border-outline-variant/20 opacity-60">
              <div className="flex items-center justify-between">
                <span className="w-6 h-6 rounded-full bg-surface-container flex items-center justify-center text-outline text-xs ">
                  {step.num}
                </span>
                <span className=" text-outline text-[11px]">{step.date}</span>
              </div>
              <div className="flex flex-col">
              ...
              <div className="mt-auto pt-1 flex items-center gap-1 text-outline text-[11px] ">

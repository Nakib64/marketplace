...
export class AdminDisputesVerdictsService {
  ...
  /**
   * Enforces 100% full escrow refund back to Client.
   */
  ...
  /**
   * Enforces 100% full release of net payout to Freelancer.
   */
  ...
  /**
   * Enforces proportional split settlement between Client and Freelancer.
   */
